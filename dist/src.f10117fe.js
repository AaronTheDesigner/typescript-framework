...
function () {
  function UserForm(parent, model) {
    ...
    this.onSetAgeClick = function () {
      return _this.model.setRandomAge();
    };
  }
...
exports.User = User;
},{"./Model":"src/models/Model.ts","./Eventing":"src/models/Eventing.ts","./Attributes":"src/models/Attributes.ts","./ApiSync":"src/models/ApiSync.ts","./Collection":"src/models/Collection.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
