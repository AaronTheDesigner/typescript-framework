...
function () {
  function Eventing() {
    ...
    this.events = {}; // <== different events unknown, so events will be an object with vague properties
...
exports.User = User;
},{"./Model":"src/models/Model.ts","./Eventing":"src/models/Eventing.ts","./Attributes":"src/models/Attributes.ts","./ApiSync":"src/models/ApiSync.ts","./Collection":"src/models/Collection.ts"}],"src/views/CollectionView.ts":[function(require,module,exports) {
"use strict";
...
var Collection_1 = require("./models/Collection"); // const user = User.buildUser({ name: 'Name', age: 20 })
